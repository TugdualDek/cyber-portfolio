...
Ansible est un outil qui automatise la gestion d'infrastructures. Il lit des "recettes" écrites en YAML pour configurer des serveurs. Notre idée : appliquer ce concept aux tests de sécurité.

</Callout>

**Le problème qu'on a vite découvert :** Les tests de sécurité peuvent durer un certains temps en fonction de leur implémentation. Comment permettre plusieurs scans simultanés sans planter l'interface ?
...
<Callout type="attention">
  **Usage éthique uniquement** Notre projet inclut des disclaimers clairs :
